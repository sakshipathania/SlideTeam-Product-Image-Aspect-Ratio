...
public class sign_up_correct_data extends Set {
	...
	public void user_lands_on_pricing_page_and_then_user_go_to_free_ppts_page_cd() throws InterruptedException  {
	    ...
	    //free_ppt_btn.click();
	    //Thread.sleep(2000);
		WebElement size=driver.findElement(By.xpath("//img[contains(@src,'https://www.slideteam.net/media/catalog/product/cache/260x195/b/u/business_puzzle_list_diagarm_powerpoint_templates_ppt_presentation_slides_0812_Slide01.jpg')]"));
	        Thread.sleep(2000);
	...
	WebElement size0=driver.findElement(By.xpath("//img[contains(@src,'https://www.slideteam.net/media/catalog/product/cache/260x195/c/h/change_management_powerpoint_presentation_slides_Slide01.jpg')]"));
		Thread.sleep(2000);
