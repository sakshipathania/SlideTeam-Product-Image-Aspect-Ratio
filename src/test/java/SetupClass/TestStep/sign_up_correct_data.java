...
public class sign_up_correct_data extends Set {
	...
	public void user_lands_on_pricing_page_and_then_user_go_to_free_ppts_page_cd() throws InterruptedException  {
	    ...
	    //free_ppt_btn.click();
	    //Thread.sleep(2000);
		WebElement size=driver.findElement(By.className("a.product photo product-item-photo"));
	        Thread.sleep(2000);
	...
	WebElement size0=driver.findElement(By.className("a.product photo product-item-photo"));
		Thread.sleep(2000);
